...
qsub="qsub -pe OpenMP 1 -l mem_free=1G -l h_rt=48:00:00 -m bes -M sheny@gis.a-star.edu.sg -j y -V -b y -cwd";
...
#$qsub -N ${JOBNAME}.snakemake -o ${JOBNAME}.snakemake.qsub.log "snakemake -j 8 -c \"qsub -pe OpenMP {threads} -l mem_free=8G -l h_rt=48:00:00 -j y -V -b y -cwd\" -s ${SMAKE} --configfile ${SCONF}";
#EOF
